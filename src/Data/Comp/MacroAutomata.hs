...
fromMacroTransId :: Functor f => MacroTransId f g -> MacroTrans f Id g
fromMacroTransId tr (Id a) t = tr a (fmap (. Id) t)
...
fromMacroTransId' :: Functor f => MacroTransId' f g -> MacroTrans f Id g
fromMacroTransId' tr (Id a) t = tr (Hole a) (fmap (\f -> Hole . f . Id) t)
